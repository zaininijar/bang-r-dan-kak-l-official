                        ...
                        <thead>
                            <th>
                                <tr
                                    ...
                                    <td class="pl-5">Metode Penukaran</td>
                        ...
                        <tbody id="searchResults">
                            ...
                            <tr tabindex="0" class="focus:outline-none h-16 border-b border-gray-100 rounded">
                                ...
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p
                                            class="font-medium leading-none bg-indigo-50 text-indigo-600 mr-2 px-4 py-2 rounded-full text-sm">
            ...
            resultsDiv.innerHTML += `<tr tabindex="0" class="focus:outline-none h-16 border-b border-gray-100 rounded">
                                        ...
                                        <td class="">
                                            <div class="flex items-center pl-5">
                                                <p
                                                    class="font-medium leading-none bg-indigo-50 text-indigo-600 mr-2 px-4 py-2 rounded-full text-sm">
                                                    ${transaction.exchange.exchanged_to}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="">
