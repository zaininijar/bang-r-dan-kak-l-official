<div class=" border-b">
    <div class="text-gray-700 py-5">
        <div x-data="{ open: false }" class="flex flex-col __container lg:items-center lg:justify-between lg:flex-row">
            ...
            <nav :class="{'flex': open, 'hidden': !open} text-base"
                ...
                <a class="px-4 py-3 rounded-lg  lg:mt-0 lg:ml-4 hover:text-gray-900 focus:text-gray-900 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                    href="#">Riwayat Penukaran</a>
                <a class="bg-indigo-600 flex items-center justify-center gap-2 text-base text-white px-4 py-3 font-medium mt-2 rounded-full  lg:mt-0 lg:ml-4 focus:text-gray-900 hover:bg-blue-600 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                    href="#">
