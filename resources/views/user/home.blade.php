<x-user-layout title="Home">
    <section class="__container min-h-[80vh]  flex items-center w-full">
        <div class="flex  items-center gap-16">
            <div class="w-8/12 flex flex-col gap-6 h-full justify-between ">
                <div class="">
            ...
            <div class=" w-4/12 aspect-square">
                <img class="object-contain object-center w-full h-full" src="{{ asset('images/char.png') }}" alt="">
            </div>
        </div>
    </section>
    <section class="__container mt-8 mb-16">
        <h2 class="text-center text-2xl underline font-semibold text-indigo-700">Tutorial Mendapatkan Point</h2>
        <div class="flex gap-x-5 mt-10 text-center">
            <div class="border p-5 flex flex-col justify-center w-6/12  rounded-lg">
            ...
            <div class="border p-5 flex flex-col justify-center w-6/12 rounded-lg">
                <h2 class="text-2xl pt-5 font-semibold">Masuk kedalam grup khusus untuk dapatkan point extra.</h2>
                <p class="pt-2 pb-5">
